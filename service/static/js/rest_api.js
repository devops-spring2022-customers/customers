$(function () {
    ...
    function update_form_data_address(res) {
        if (res.length > 0){
            $("#address_id").val(res[res.addresses.length-1].id);
            $("#customer_address_id").val(res[res.addresses.length-1].customer_id);
            $("#customer_street").val(res[res.addresses.length-1].street);
            $("#customer_city").val(res[res.addresses.length-1].city);
            $("#customer_state").val(res[res.addresses.length-1].state);
            $("#customer_postalcode").val(res[res.addresses.length-1].postal_code);
        }
    }
