$(function () {
    ...
    function flash_message_address(message) {
        $("#flash_message_address").empty();
        $("#flash_message_address").append(message);
    }
    ...
    $("#search-address-btn").click(function () {
        ...
        ajax.done(function(res){
            ...
            table += '</tbody></table>';
            $("#search_results_address").append(table);
